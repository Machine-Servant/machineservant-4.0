...
That's it for this article. You can now click on a game in the search list and see the game details. ~In the next article, we'll add some OptimisticUI to the various routes~! (Update: 1/26/2024 - I've decided to skip the OptimisticUI article for now. I may come back to it in the future.)
