...
The `React.HTMLAttributes` interface contains all HTML attributes that can be passed to a React component. **This interface can pass down all HTML attributes to a React component.** You can use the destructuring syntax `...props` to gather all the HTML attributes and pass them down to the component.
